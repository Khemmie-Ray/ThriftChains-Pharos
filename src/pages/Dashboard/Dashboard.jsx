    ...
    <main className="">
      ...
      <section className="flex justify-between my-8 lg:px-8 md:px-8 px-4 items-center flex-col lg:flex-row md:flex-row">
        ...
        <div className="bg-[#EFEBFF] rounded-full lg:w-[40%] md:w-[40%] w-[100%] flex items-center justify-between mb-3">
          <Button
            className={`px-4 py-3 rounded-full focus:outline-none ${selectedTab === "thrifter" ? selectedStyle : defaultStyle}`}
            onClick={() => setSelectedTab("thrifter")}
          >
            Thrifter Dashboard
          </Button>
          <Button
            className={`px-4 py-3 rounded-full focus:outline-none ${selectedTab === "assetOwner" ? selectedStyle : defaultStyle}`}
